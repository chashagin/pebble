// Surface the engine's free functions unqualified, mirroring Swift's global
// functions, so the rest of the port reads like the original. One entry per
// static class that holds module-level free funcs/vars.
